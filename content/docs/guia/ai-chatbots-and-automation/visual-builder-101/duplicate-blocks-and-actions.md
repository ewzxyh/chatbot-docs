---
title: "# # #"
description: "Duplicar Blocos e ações"
---

Duplicar Blocos e ações

ChatCase permite que você crie agentes de IA sem código de forma rápida e eficiente. &#x20;

Uma característica chave que simplifica o processo de design é a capacidade de usar Copiar e Colar.\
Esse recurso permite que você duplique um [Block] inteiro (/ai-chatbots-and-automation/visual-builder-101/how-to-create-a-block) ou apenas uma ação dentro de um Bloco, tornando seu processo de design mais rápido e flexível.
...
Para fazer isso, passe o cursor sobre a Ação que deseja copiar. Uma pequena barra de ferramentas aparecerá no lado esquerdo. Clique na opção "Copiar ação".
...
Se necessitar de mais assistência, não hesite em entrar em contato-nos em [**redacted@example.invalid** ](mailto:redacted@example.invalid)
