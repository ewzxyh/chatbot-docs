...
<figure><img src="/files/SAh8RkThFNkEJYmaWUg3" alt=""><figcaption></figcaption></figure>Quando você precisa entregar um chat de um fluxo para um operador humano (HITL: Humano no loop) esta é a ação que faz o trabalho para você.
...
<figure><img src="/files/NQSBx7T2BH6BUmjHKhuY" alt=""><figcaption></figcaption></figure>Para criar este fluxo, basta arrastar e soltar a entrega humana do menu lateral para o palco.

<figure><img src="/files/nZeITSHnrdV4QFvjcNYX" alt=""><figcaption></figcaption></figure>Uma vez conectado a um botão (ou qualquer bloco no fluxo) esta ação moverá o fluxo para um agente disponível, se houver. Se nenhum agente estiver disponível, a ação será movida automaticamente para o status *unassignado* e colocada na fila *unassignado*.
...
<figure><img src="/files/kibgFx0JhAD0WunJ9aGf" alt=""><figcaption></figcaption></figure>Se nenhum agente estiver disponível, o chat será novamente colocado no status Não atribuído (você verá o chat no painel Monitor sob a seção *Desatribuído*).
