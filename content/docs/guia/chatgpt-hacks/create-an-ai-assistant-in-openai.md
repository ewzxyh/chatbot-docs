---
title: "Criar um Assistente de IA no OpenAI"
description: "O OpenAI ativou recentemente Assistentes que podem trabalhar perfeitamente com diferentes formatos de arquivo, como o Google Sheets. Este avanço permite criar um assistente de IA p"
---

O OpenAI ativou recentemente Assistentes que podem trabalhar perfeitamente com diferentes formatos de arquivo, como o Google Sheets. Este avanço permite criar um assistente de IA para vendas e suporte usando o modelo mais recente, ChatGPT-4o.

Agora você pode desenvolver um assistente de vendas de IA que utiliza uma lista de produtos para orientar os usuários a encontrar o melhor produto adequado em segundos, ao invés de deixá-los peneirar dezenas ou centenas de produtos similares.
...
Por favor, note que um plano personalizado do OpenAI é necessário para este tutorial. Se você não tem um, não há necessidade de se preocupar – contate-nos em [**redacted@example.invalid**](mailto:redacted@example.invalid), e forneceremos acesso ao nosso.
...
Caso precise de mais assistência, não hesite em entrar em contato-nos através de [**redacted@example.invalid**](mailto:redacted@example.invalid)**.
