---
title: "Começando com o ticket de e-mail em ChatCase"
description: "Introduçãoa href=\"introduction\" id=\"introduction\"/aCom o ChatCase você pode conversar perfeitamente com seus clientes em vários canais. Você pode mudar rapidamente do canal de e-ma"
---
...
**Passo 2**: Clique em e-mail sub menu na barra lateral
...
Aceitar solicitações de suporte via endereços de e-mail externos também é suportado. Se você já tiver um endereço de e-mail de suporte, você pode encaminhar e-mail recebido nesses endereços para o seu domínio de e-mail do ChatCase. Por exemplo, se você quiser receber solicitações de suporte em[redacted@example.invalid](mailto:redacted@example.invalid)em vez de suporte@\<Project\_id>.tickets.ChatCase.com, você deve **avançar** o e-mail de[redacted@example.invalid](mailto:redacted@example.invalid)suportar@\<Project\_id>.tickets.chatcase.com.

Faça isso:

** Passo 1**: Copie o endereço de e-mail para a frente das Configurações → Email → Integre-se com seu provedor de caixa de correio (imagem anterior)
...
Nota: Qualquer mensagem enviada para sua caixa de correio externa cria um ticket do ChatCase, ou atualização do ticket. No entanto, responder ao e-mail de um cliente dentro da caixa de correio do endereço de suporte externo envia uma mensagem ao cliente, mas não atualiza o ticket em ChatCase. Para garantir que suas respostas de e-mail atualizem o ticket, você precisa enviar essa resposta do endereço de e-mail do ChatCase, ou da interface do agente do ChatCase.
