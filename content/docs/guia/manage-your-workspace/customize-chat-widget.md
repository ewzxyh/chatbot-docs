---
title: "Personalizar o widget de chat"
description: "Com o ChatCase, você não só pode personalizar a aparência do seu widget de chat, mas também gerenciar sua visibilidade, comportamento e recursos. Este tutorial irá guiá-lo através "
---

Com o ChatCase, você não só pode personalizar a aparência do seu widget de chat, mas também gerenciar sua visibilidade, comportamento e recursos. Este tutorial irá guiá-lo através de várias opções de personalização para garantir que o widget se encaixa perfeitamente em seu site.
...
* **Cor Primária:** Esta cor é usada como fundo para elementos chave, como botões.
* **Cor Secundária:** Aplicado ao texto e ícones.
* ** Gradiente Primário de Cores:** Activar ou desativar o efeito de gradiente na cor primária.
* **Upload Logo:**
* Seu logotipo deve ser **menos de 1024KB** e idealmente **78px x 78px** de tamanho. Recomendamos o uso de **PNG** ou **GIF** com um fundo transparente para a melhor exibição.
* ** Widget Alinhamento: ** Escolha se deseja exibir o widget no lado ** esquerdo** ou ** direito** da página.

Depois de fazer essas alterações, você verá a visualização ao vivo no lado direito da tela. Não se esqueça de clicar no botão **Salvar** para aplicá-los.
...
* ** Versão móvel:**
* ** Ligar/Desligar: ** Gerencie visibilidade para usuários móveis.
* ** Modo de exibição:** Semelhante ao desktop, escolha se ele permanece **Open**, **Closed**, ou em seu **Last State**.

3. ** Modo de conversação única

Activar ** Modo de conversação única** para restringir o widget a apenas uma conversa em curso de cada vez. &#x20;

Este recurso simplifica a experiência para os usuários e impede várias conversas abertas. Ele também esconde a lista de conversas abertas e arquivadas.

# # 4. # Unbranding #

* **Widget Footer Unbranding:**
* Remover o texto "Desenvolvido por" no rodapé do widget, apagando esta string nas configurações. Você também pode substituir o logotipo do rodapé e URL por sua marca personalizada.
...
Alterações feitas às saudações aparecerão imediatamente na pré-visualização, e você pode salvá-las clicando em **Salvar**.
...
* ** Activar/desativar a Chamada:** Este recurso permite que você mostre um prompt para usuários.
* ** Timer:** Defina um atraso em segundos antes da chamada aparecer.
* **Título e Mensagem:** Personalize o título e a mensagem que aparecerão na chamada.
...
### 9.**Exibir em Páginas Específicas**
...
* ** Emojis:**
* ** Activar/desativar Emojis:** Permitir que os usuários enviem emojis ou escondam o botão emoji.
* ** Gravador de Vozes: **
* **Ativar/desativar mensagens de voz:** Permitir que os usuários enviem mensagens de voz ou apenas mensagens de texto desabilitando o botão gravador de voz.

Espero que este guia o ajude a personalizar seu widget ChatCase para atender às suas necessidades. Se precisares de mais apoio, estamos aqui para ajudar!

Envie-nos um e-mail para[redacted@example.invalid](mailto:redacted@example.invalid)Você também pode explorar casos de uso e encontrar mais detalhes em nosso site: [www.chatcase.com](https://www.chatcase.com).
