...
<figure><img src="/doc-images/gT0S0tcNIRTyHLmY1Zeu.png" alt=""><figcaption></figcaption></figure>Agora, vamos conectar ChatCase ao Zendesk usando [**Make**](/docs/guia/ai-chatbots-and-automation/actions-explained/make.com-action).&#x20;
...
<figure><img src="/doc-images/HiQ74POtAsgl33Yk6CQP.png" alt=""><figcaption></figcaption></figure>Quando você clicar no bloco Make, uma popup aparecerá à direita. É aqui que você define quais informações devem ser enviadas para o Make. Na seção ** Parâmetros do Corpo**, mapeie os detalhes do usuário para os seguintes atributos:
...
<figure><img src="/doc-images/z2tfJTmrZnSnp12oJzH5.png" alt=""><figcaption></figcaption></figure>Óptimo! Essa é a configuração ChatCase feito. Agora, vamos passar para a configuração do Zendesk.
...
<figure><img src="/doc-images/GnNep2IIjU4fXgilW9uO.png" alt=""><figcaption></figcaption></figure>Em seguida, volte para o seu painel ChatCase, e no bloco **Make** do fluxo do seu bot, cole o URL webhook que você acabou de copiar.

<figure><img src="/doc-images/FAAp3QoFtXqAbcwJO00U.png" alt=""><figcaption></figcaption></figure>Agora, retorne ao Make e adicione um novo módulo chamado **Zendesk - Criar um Ticket**.&#x20;
...
<figure><img src="/doc-images/A9tBUb0v8kgzaHDlRLvF.png" alt=""><figcaption></figcaption></figure>Uma vez que você tenha feito isso, seu cenário Make estará pronto para conectar o ChatCase com o Zendesk.&#x20;
...
<figure><img src="/doc-images/NOhjg9yjuXQs9ysKeHkf.png" alt=""><figcaption></figcaption></figure>Agora temos de voltar ao cenário do Make.
...
<figure><img src="/doc-images/I0WtJtyrKAZQuUyjQCNf.png" alt=""><figcaption></figcaption></figure>Sinta-se livre para personalizar outros campos com base em suas necessidades específicas.
...
<figure><img src="/doc-images/x3CZGKeP24HhH9QtwgjG.png" alt=""><figcaption></figcaption></figure>Em seguida, verifique o painel Make para ver se o cenário foi executado com sucesso e recebeu os dados do ChatCase.
...
<figure><img src="/doc-images/MhCmRKXHWt1SqWKzLlyU.png" alt=""><figcaption></figcaption></figure>Agora, sua integração está ao vivo, e quaisquer novas interações com seu bot ChatCase criarão automaticamente tickets no Zendesk.
