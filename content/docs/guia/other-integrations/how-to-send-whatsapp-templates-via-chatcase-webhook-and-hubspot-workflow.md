...
<figure><img src="/doc-images/ZQpBRPXZyHTUz5CwmrxJ.png" alt=""><figcaption></figcaption></figure>## # 2. Crie um Webhook em ChatCase Design Studio<a href="#id-2-create-a-webhook-in-chatcase-design-studio" id="id-2-create-a-webhook-in-chatcase-design-studio"></a>Vá para a seção **Bots** em seu console ChatCase.
...
<figure><img src="/doc-images/9lQHgLrIqhl1p6IQYQZz.png" alt=""><figcaption></figcaption></figure># # # 4. Configure a ação de envio do modelo do WhatsApp[#] (https://gethelp.chatcase.com/articles/how-to-send-whatsapp-templates-via-chatcase-webhook-and-hubspot-workflow/#4-configure-the-whatsapp-template-sending-action) <a href="#id-4-configure-the-whatsapp-template-sending-action" id="id-4-configure-the-whatsapp-template-sending-action"></a>No menu **Ações** à esquerda, sob a guia **Integrações**, selecione **Enviar WhatsApp**.
...
<figure><img src="/doc-images/T8iRJm3zlZeByxGX3GiH.png" alt=""><figcaption></figcaption></figure>Para o porto **Outro**:
...
<figure><img src="/doc-images/t2cHL045jofAVDaZc6qB.png" alt=""><figcaption></figcaption></figure>## # 5. Configure o HubSpot para ativar o WhatsApp Webhook[#] (https://gethelp.chatcase.com/articles/how-to-send-whatsapp-templates-via-chatcase-webhook-and-hubspot-workflow/#5-configure-hubspot-to-trigger-the-whatsapp-webhook) <a href="#id-5-configure-hubspot-to-trigger-the-whatsapp-webhook" id="id-5-configure-hubspot-to-trigger-the-whatsapp-webhook"></a>Entre na sua conta HubSpot.
...
<figure><img src="/doc-images/tS3Z2iMUzZMIk9x2jIEj.png" alt=""><figcaption></figcaption></figure># # # Adicione uma ação Webhook # #https://gethelp.chatcase.com/articles/how-to-send-whatsapp-templates-via-chatcase-webhook-and-hubspot-workflow/#add-a-webhook-action) <a href="#add-a-webhook-action" id="add-a-webhook-action"></a>Clique no ícone plus abaixo do gatilho de inscrição.
...
<figure><img src="/doc-images/hNxJiItUHbtxidXel4NN.png" alt=""><figcaption></figcaption></figure>Teste o fluxo de trabalhohttps://gethelp.chatcase.com/articles/how-to-send-whatsapp-templates-via-chatcase-webhook-and-hubspot-workflow/#test-the-workflow) <a href="#test-the-workflow" id="test-the-workflow"></a>Mova um acordo de teste para o estágio "Contrato Enviado" no seu gasoduto.
